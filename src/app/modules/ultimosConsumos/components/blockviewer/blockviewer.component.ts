        ...
        <div class="block-header">
            <span class="block-title">
                <ul class="list-none p-0 m-0 flex align-items-left font-medium mb-3">
                    <li>                    
                        <a class="text-900 font-bold text-4xl mb-4 text-left">{{header}}</a>
                    </li>
                    <li class="px-2" *ngIf="submenu">
                        <i class="pi pi-angle-right text-900 font-bold text-4xl line-height-3"></i>
                    </li>
                    <li>
                        <span class="text-900 font-bold text-4xl mb-4 text-left" *ngIf="submenu">{{item2}}</span>
                    </li>
                </ul>                                
            </span>                    
        </div>
